...
particle::particle(){
    ...
    //creates random variation for deviation of web fibers from nodes
    maxWebDisplacement = 4;
    x1 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
    x2 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
    x3 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
    y1 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
    y2 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
    y3 = ofRandom(-maxWebDisplacement,maxWebDisplacement);
}
